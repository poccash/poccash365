...
public final class DigitalGoodsStore {
  ...
  public static class Goods {
    ...
    private static Pc365Key.LongKeyFactory<Goods> goodsDbKeyFactory() {
      return Pc365.getStores().getDigitalGoodsStoreStore().getGoodsDbKeyFactory();
    }

    private static VersionedEntityTable<Goods> goodsTable() {
      return Pc365.getStores().getDigitalGoodsStoreStore().getGoodsTable();
    }
    ...
    protected Goods(long id, Pc365Key dbKey, long sellerId, String name, String description, String tags, int timestamp,
    ...
    public Goods(Pc365Key dbKey, Transaction transaction, Attachment.DigitalGoodsListing attachment) {
      this.dbKey = dbKey;
  ...
  public static class Purchase {
    ...
    private static Pc365Key.LongKeyFactory<Purchase> purchaseDbKeyFactory() {
      return Pc365.getStores().getDigitalGoodsStoreStore().getPurchaseDbKeyFactory();
    }

    private static Pc365Key.LongKeyFactory<Purchase> feedbackDbKeyFactory() {
      return Pc365.getStores().getDigitalGoodsStoreStore().getFeedbackDbKeyFactory();
    }

    private static VersionedValuesTable<Purchase, EncryptedData> feedbackTable() {
      return Pc365.getStores().getDigitalGoodsStoreStore().getFeedbackTable();
    }

    private static Pc365Key.LongKeyFactory<Purchase> publicFeedbackDbKeyFactory() {
      return Pc365.getStores().getDigitalGoodsStoreStore().getPublicFeedbackDbKeyFactory();
    }

    private static VersionedValuesTable<Purchase, String> publicFeedbackTable() {
      return Pc365.getStores().getDigitalGoodsStoreStore().getPublicFeedbackTable();
    }
    ...
    protected Purchase(long id, Pc365Key dbKey, long buyerId, long goodsId, long sellerId, int quantity,
