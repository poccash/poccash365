...
public class AtConstants {
    ...
    private AtConstants() {
        ...
        STEP_FEE.put((short) 1, Constants.ONE_PC365 / 10L);
        MAX_STEPS.put((short) 1, 2000L);
        API_STEP_MULTIPLIER.put((short) 1, 10L);

        COST_PER_PAGE.put((short) 1, Constants.ONE_PC365);
        ...
        MAX_PAYLOAD_FOR_BLOCK.put((short) 1, (Pc365.getFluxCapacitor().getValue(FluxValues.MAX_PAYLOAD_LENGTH)) / 2L); //use at max half size of the block.
        ...
        MAX_PAYLOAD_FOR_BLOCK.put((short) 2, (Pc365.getFluxCapacitor().getValue(FluxValues.MAX_PAYLOAD_LENGTH)) / 2L); //use at max half size of the block.
    ...
    public short atVersion(int blockHeight) {
        return Pc365.getFluxCapacitor().getValue(FluxValues.AT_VERSION, blockHeight);
    }
