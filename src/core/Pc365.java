...
import core.assetexchange.AssetExchangeImpl;
import core.at.AT;
import core.db.BlockDb;
import core.db.TransactionDb;
import core.db.cache.DBCacheManagerImpl;
import core.db.sql.Db;
import core.db.store.BlockchainStore;
import core.db.store.Dbs;
import core.db.store.DerivedTableManager;
import core.db.store.Stores;
import core.deeplink.DeeplinkQRCodeGenerator;
import core.feesuggestions.FeeSuggestionCalculator;
import core.fluxcapacitor.FluxCapacitor;
import core.fluxcapacitor.FluxCapacitorImpl;
import core.grpc.proto.CoreService;
import core.http.API;
import core.http.APITransactionManager;
import core.http.APITransactionManagerImpl;
import core.peer.Peers;
import core.props.PropertyService;
import core.props.PropertyServiceImpl;
import core.props.Props;
import core.services.*;
import core.services.impl.*;
import core.statistics.StatisticsManagerImpl;
import core.util.DownloadCacheImpl;
import core.util.LoggerConfigurator;
...
public final class Pc365 {

  public static final Version VERSION = Version.parse("v2.4.0-dev");
  public static final String APPLICATION = "CORE";

  private static final String DEFAULT_PROPERTIES_NAME = "core-default.properties";

  private static final Logger logger = LoggerFactory.getLogger(Pc365.class);
  ...
  private static PropertyService loadProperties() {
    ...
    logger.info("Initializing Pc365 Reference Software (CORE) version {}", VERSION);
    ...
    try (InputStream is = ClassLoader.getSystemResourceAsStream("core.properties")) {
      properties = new Properties(defaultProperties);
      if (is != null) { // parse if core.properties was loaded
        properties.load(is);
      }
    } catch (IOException e) {
      throw new RuntimeException("Error loading core.properties", e);
    }
  ...
  public static void main(String[] args) {
    Runtime.getRuntime().addShutdownHook(new Thread(Pc365::shutdown));
    init();
  }
  ...
  private static void loadWallet(PropertyService propertyService) {
    ...
    Pc365.propertyService = propertyService;
    ...
    try {
      ...
      logger.info("CORE {} started successfully.", VERSION);
    ...
    (new Thread(Pc365::commandHandler)).start();
  }
  ...
  public static void shutdown(boolean ignoreDBShutdown) {
    ...
    logger.info("CORE {} stopped.", VERSION);
