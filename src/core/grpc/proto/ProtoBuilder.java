...
public final class ProtoBuilder {
    ...
    public static CoreApi.Account buildAccount(Account account, AccountService accountService) {
        ...
        return CoreApi.Account.newBuilder()
                .setId(account.getId())
    ...
    public static CoreApi.AssetBalance buildAssetBalance(Account.AccountAsset asset) {
        return CoreApi.AssetBalance.newBuilder()
    ...
    public static CoreApi.Block buildBlock(Blockchain blockchain, BlockService blockService, Block block, boolean includeTransactions) {
        CoreApi.Block.Builder builder = CoreApi.Block.newBuilder()
                .setId(block.getId())
    ...
    public static CoreApi.BasicTransaction buildBasicTransaction(Transaction transaction) {
        CoreApi.BasicTransaction.Builder builder = CoreApi.BasicTransaction.newBuilder()
    ...
    public static CoreApi.Transaction buildTransaction(Transaction transaction, int currentHeight) {
        return CoreApi.Transaction.newBuilder()
    ...
    public static CoreApi.Transaction buildUnconfirmedTransaction(Transaction transaction) {return CoreApi.Transaction.newBuilder()
            .setTransaction(buildBasicTransaction(transaction))
            .setId(transaction.getId())
            .setTransactionBytes(buildByteString(transaction.getBytes()))
            .setBlockHeight(transaction.getHeight())
    ...
    public static CoreApi.AT buildAT(AccountService accountService, AT at) {
    ...
    public static CoreApi.Alias buildAlias(Alias alias, Alias.Offer offer) {
        CoreApi.Alias.Builder builder = CoreApi.Alias.newBuilder()
                .setId(alias.getId())
    ...
    public static CoreApi.EncryptedData buildEncryptedData(EncryptedData encryptedData) {
        if (encryptedData == null) return CoreApi.EncryptedData.getDefaultInstance(); // TODO is this needed for all methods?
        return CoreApi.EncryptedData.newBuilder()
                .setData(buildByteString(encryptedData.getData()))
                .setNonce(buildByteString(encryptedData.getNonce()))
                .build();
    }

    public static EncryptedData parseEncryptedData(CoreApi.EncryptedData encryptedData) {
        return new EncryptedData(encryptedData.getData().toByteArray(), encryptedData.getNonce().toByteArray());
    }

    public static CoreApi.IndexRange sanitizeIndexRange(CoreApi.IndexRange indexRange) {
        CoreApi.IndexRange.Builder newIndexRange = indexRange.toBuilder();
    ...
    public static CoreApi.Asset buildAsset(AssetExchange assetExchange, Asset asset) {
        return CoreApi.Asset.newBuilder()
    ...
    public static CoreApi.Subscription buildSubscription(Subscription subscription) {
        return CoreApi.Subscription.newBuilder()
    ...
    public static CoreApi.Order buildOrder(Order order) {
        return CoreApi.Order.newBuilder()
                .setId(order.getId())
    ...
    public static CoreApi.DgsGood buildGoods(DigitalGoodsStore.Goods goods) {
        return CoreApi.DgsGood.newBuilder()
                .setId(goods.getId())
    ...
    public static CoreApi.EscrowTransaction buildEscrowTransaction(Escrow escrow) {
        return CoreApi.EscrowTransaction.newBuilder()
    ...
    public static CoreApi.AssetTrade buildTrade(Trade trade, Asset asset) {
        return CoreApi.AssetTrade.newBuilder()
                .setAsset(trade.getAssetId())
                .setTradeType(trade.isBuy() ? CoreApi.AssetTradeType.BUY : CoreApi.AssetTradeType.SELL)
    ...
    public static CoreApi.AssetTransfer buildTransfer(AssetTransfer assetTransfer, Asset asset) {
        return CoreApi.AssetTransfer.newBuilder()
    ...
    public static CoreApi.DgsPurchase buildPurchase(DigitalGoodsStore.Purchase purchase, DigitalGoodsStore.Goods goods) {
        return CoreApi.DgsPurchase.newBuilder()
    ...
    public static Transaction parseBasicTransaction(Blockchain blockchain, CoreApi.BasicTransaction basicTransaction) throws ApiException {
        try {
            ...
            for (Any appendix : basicTransaction.getAppendagesList()) {
                try {
                    if (appendix.is(CoreApi.MessageAppendix.class)) {
                        transactionBuilder.message(new Appendix.Message(appendix.unpack(CoreApi.MessageAppendix.class), blockchainHeight));
                    } else if (appendix.is(CoreApi.EncryptedMessageAppendix.class)) {
                        CoreApi.EncryptedMessageAppendix encryptedMessageAppendix = appendix.unpack(CoreApi.EncryptedMessageAppendix.class);
                    ...
                    } else if (appendix.is(CoreApi.PublicKeyAnnouncementAppendix.class)) {
                        transactionBuilder.publicKeyAnnouncement(new Appendix.PublicKeyAnnouncement(appendix.unpack(CoreApi.PublicKeyAnnouncementAppendix.class), blockchainHeight));
                    }
        ...
        } catch (Pc365Exception.NotValidException e) {
