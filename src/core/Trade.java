...
public class Trade {
  ...
  protected Trade(int timestamp, long assetId, long blockId, int height,
                  ...
                  long sellerId, long buyerId, Pc365Key dbKey, long quantityQNT, long priceNQT) {
  ...
  public Trade(Pc365Key dbKey, long assetId, Block block, Order.Ask askOrder, Order.Bid bidOrder) {
    this.dbKey = dbKey;
