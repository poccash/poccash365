...
public final class Constants {
  ...
  public static final int PC365_DIFF_ADJUST_CHANGE_BLOCK = 2700;

  public static final long PC365_REWARD_RECIPIENT_ASSIGNMENT_WAIT_TIME = 4;

  // not sure when these were enabled, but they each do an alias lookup every block if greater than the current height
  public static final long PC365_ESCROW_START_BLOCK = 0;
  public static final long PC365_SUBSCRIPTION_START_BLOCK = 0;
  public static final int PC365_SUBSCRIPTION_MIN_FREQ = 3600;
  public static final int PC365_SUBSCRIPTION_MAX_FREQ = 31536000;

  public static final int BLOCK_HEADER_LENGTH = 232;

  public static final long MAX_BALANCE_PC365 = 2158812800L;
  
  public static final long FEE_QUANT =    735000;
  public static final long ONE_PC365 = 100000000;

  public static final long MAX_BALANCE_NQT = MAX_BALANCE_PC365 * ONE_PC365;
  public static final long INITIAL_BASE_TARGET = 18325193796L;
  public static final long MAX_BASE_TARGET = 18325193796L;
  public static final int MAX_ROLLBACK = Pc365.getPropertyService().getInt(Props.DB_MAX_ROLLBACK);
  ...
  public static final long ASSET_ISSUANCE_FEE_NQT = 1000 * ONE_PC365;
  ...
  static final long UNCONFIRMED_POOL_DEPOSIT_NQT = (Pc365.getPropertyService().getBoolean(Props.DEV_TESTNET) ? 50 : 100) * ONE_PC365;

  // TODO pc365kit4j integration
  ...
  static {
    ...
    if (MAX_ROLLBACK < 1440) {
      throw new IllegalArgumentException("core.maxRollback must be at least 1440");
    }
  }
