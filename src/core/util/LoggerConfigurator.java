...
/**
 * Handle logging for the Pc365 node server
 */
...
public final class LoggerConfigurator {
  ...
  public static void init() {
    ...
    System.setProperty(managerPackage, "core.util.Pc365LogManager");
    if (!(LogManager.getLogManager() instanceof Pc365LogManager)) {
      System.setProperty(managerPackage,
                         (oldManager != null ? oldManager : "java.util.logging.LogManager"));
    }
    if (!Boolean.getBoolean("core.doNotConfigureLogging")) {
      try {
  ...
  public static void shutdown() {
    if (LogManager.getLogManager() instanceof Pc365LogManager) {
      ((Pc365LogManager) LogManager.getLogManager()).pc365Shutdown();
    }
  }
}
