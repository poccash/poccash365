...
import static core.schema.Tables.INDIRECT_INCOMING;
...
public class SqlIndirectIncomingStore implements IndirectIncomingStore {
    ...
    public SqlIndirectIncomingStore(DerivedTableManager derivedTableManager) {
        Pc365Key.LinkKeyFactory<IndirectIncoming> indirectIncomingDbKeyFactory = new DbKey.LinkKeyFactory<IndirectIncoming>("account_id", "transaction_id") {
            @Override
            public Pc365Key newKey(IndirectIncoming indirectIncoming) {
