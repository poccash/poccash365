...
import core.schema.tables.records.AssetTransferRecord;
...
import static core.schema.Tables.ASSET_TRANSFER;

public class SqlAssetTransferStore implements AssetTransferStore {

  private static final Pc365Key.LongKeyFactory<AssetTransfer> transferDbKeyFactory = new DbKey.LongKeyFactory<AssetTransfer>(ASSET_TRANSFER.ID) {

      @Override
      public Pc365Key newKey(AssetTransfer assetTransfer) {
  ...
  public SqlAssetTransferStore(DerivedTableManager derivedTableManager) {
    assetTransferTable = new EntitySqlTable<AssetTransfer>("asset_transfer", core.schema.Tables.ASSET_TRANSFER, transferDbKeyFactory, derivedTableManager) {
  ...
  @Override
  public Pc365Key.LongKeyFactory<AssetTransfer> getTransferDbKeyFactory() {
