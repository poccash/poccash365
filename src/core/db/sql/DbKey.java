...
public interface DbKey extends Pc365Key {

  abstract class Factory<T> implements Pc365Key.Factory<T> {
  ...
  abstract class LongKeyFactory<T> extends Factory<T> implements Pc365Key.LongKeyFactory<T> {
  ...
  abstract class LinkKeyFactory<T> extends Factory<T> implements Pc365Key.LinkKeyFactory<T> {
