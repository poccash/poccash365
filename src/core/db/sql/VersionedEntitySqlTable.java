...
public abstract class VersionedEntitySqlTable<T> extends EntitySqlTable<T> implements VersionedEntityTable<T> {
  ...
  VersionedEntitySqlTable(String table, TableImpl<?> tableClass, Pc365Key.Factory<T> dbKeyFactory, DerivedTableManager derivedTableManager) {
  ...
  public boolean delete(T t) {
    ...
    return Db.useDSLContext(ctx -> {
      try {
        ...
        countQuery.addConditions(heightField.lt(Pc365.getBlockchain().getHeight()));
