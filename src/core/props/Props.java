...
public class Props {
  ...
  public static final Prop<Boolean> CORE_DEBUG_TRACE_ENABLED = new Prop<>("core.debugTraceEnable", false);
  public static final Prop<String> CORE_DEBUG_TRACE_QUOTE = new Prop<>("core.debugTraceQuote", "\"");
  public static final Prop<String> CORE_DEBUG_TRACE_SEPARATOR = new Prop<>("core.debugTraceSeparator", "\t");
  public static final Prop<Boolean> CORE_DEBUG_LOG_CONFIRMED = new Prop<>("core.debugLogUnconfirmed", false);
  public static final Prop<String> CORE_DEBUG_TRACE_ACCOUNTS = new Prop<>("core.debugTraceAccounts", "");

  public static final Prop<String> CORE_DEBUG_TRACE_LOG = new Prop<>("core.debugTraceLog", "LOG_AccountBalances_trace.csv");
  public static final Prop<Integer> CORE_COMMUNICATION_LOGGING_MASK = new Prop<>("core.communicationLoggingMask", 0);

  public static final Prop<Integer> CORE_SHUTDOWN_TIMEOUT = new Prop<>("core.ShutdownTimeout", 180);
  ...
  // DB options
  public static final Prop<String> DB_URL          = new Prop<>("DB.Url", "jdbc:mariadb://localhost:3306/pc365wallet");
  ...
  public static final Prop<Boolean> CORE_TEST_UNCONFIRMED_TRANSACTIONS = new Prop<>("core.testUnconfirmedTransactions", false);

  public static final Prop<Boolean> DB_H2_DEFRAG_ON_SHUTDOWN = new Prop<>("Db.H2.DefragOnShutdown", false);


  public static final Prop<Integer> CORE_BLOCK_CACHE_MB = new Prop<>("core.blockCacheMB", 40);
  ...
  public static final Prop<Integer> P2P_PORT        = new Prop<>("P2P.Port", 7108);
  ...
  public static final Prop<Integer> API_PORT    = new Prop<>("API.Port", 7107);
  public static final Prop<String> API_V2_LISTEN  = new Prop<>("API.V2.Listen", "0.0.0.0");
  public static final Prop<Integer> API_V2_PORT    = new Prop<>("API.V2.Port", 7109);
