...
public interface Appendix {
  ...
  abstract class AbstractAppendix implements Appendix {
    ...
    AbstractAppendix(int blockchainHeight) {
      this.version = (byte)(Pc365.getFluxCapacitor().getValue(FluxValues.DIGITAL_GOODS_STORE, blockchainHeight) ? 1 : 0);
    }
    ...
    public abstract void validate(Transaction transaction) throws Pc365Exception.ValidationException;
  ...
  class Message extends AbstractAppendix {
    ...
    public Message(ByteBuffer buffer, byte transactionVersion) throws Pc365Exception.NotValidException {
      ...
      if (messageLength > Constants.MAX_ARBITRARY_MESSAGE_LENGTH) {
        throw new Pc365Exception.NotValidException("Invalid arbitrary message length: " + messageLength);
      }
    ...
    public Message(CoreApi.MessageAppendix messageAppendix, int blockchainHeight) {
      super(blockchainHeight);
    ...
    public void validate(Transaction transaction) throws Pc365Exception.ValidationException {
      if (this.isText && transaction.getVersion() == 0) {
        throw new Pc365Exception.NotValidException("Text messages not yet enabled");
      }
      if (transaction.getVersion() == 0 && transaction.getAttachment() != Attachment.ARBITRARY_MESSAGE) {
        throw new Pc365Exception.NotValidException("Message attachments not enabled for version 0 transactions");
      }
      if (messageBytes.length > Constants.MAX_ARBITRARY_MESSAGE_LENGTH) {
        throw new Pc365Exception.NotValidException("Invalid arbitrary message length: " + messageBytes.length);
      }
    }
    ...
    public Any getProtobufMessage() {
      return Any.pack(CoreApi.MessageAppendix.newBuilder()
  ...
  abstract class AbstractEncryptedMessage extends AbstractAppendix {
    ...
    private AbstractEncryptedMessage(ByteBuffer buffer, byte transactionVersion) throws Pc365Exception.NotValidException {
      super(buffer, transactionVersion);
    ...
    private AbstractEncryptedMessage(CoreApi.EncryptedMessageAppendix encryptedMessageAppendix, int blockchainHeight) {
      super(blockchainHeight);
    ...
    @Override
    public Any getProtobufMessage() {
      return Any.pack(CoreApi.EncryptedMessageAppendix.newBuilder()
              .setVersion(super.getVersion())
    ...
    public void validate(Transaction transaction) throws Pc365Exception.ValidationException {
      if (encryptedData.getData().length > Constants.MAX_ENCRYPTED_MESSAGE_LENGTH) {
        throw new Pc365Exception.NotValidException("Max encrypted message length exceeded");
      }
      if ((encryptedData.getNonce().length != 32 && encryptedData.getData().length > 0)
        ...
        throw new Pc365Exception.NotValidException("Invalid nonce length " + encryptedData.getNonce().length);
      }
    }
    ...
    protected abstract CoreApi.EncryptedMessageAppendix.Type getType();
  }
  ...
  class EncryptedMessage extends AbstractEncryptedMessage {
    ...
    public EncryptedMessage(ByteBuffer buffer, byte transactionVersion) throws Pc365Exception.ValidationException {
      super(buffer, transactionVersion);
    }
    ...
    public EncryptedMessage(CoreApi.EncryptedMessageAppendix encryptedMessageAppendix, int blockchainHeight) {
      super(encryptedMessageAppendix, blockchainHeight);
      if (encryptedMessageAppendix.getType() != CoreApi.EncryptedMessageAppendix.Type.TO_RECIPIENT) throw new IllegalArgumentException();
    }
    ...
    public void validate(Transaction transaction) throws Pc365Exception.ValidationException {
      ...
      if (! transaction.getType().hasRecipient()) {
        throw new Pc365Exception.NotValidException("Encrypted messages cannot be attached to transactions with no recipient");
      }
      if (transaction.getVersion() == 0) {
        throw new Pc365Exception.NotValidException("Encrypted message attachments not enabled for version 0 transactions");
      }
    }

    @Override
    protected CoreApi.EncryptedMessageAppendix.Type getType() {
      return CoreApi.EncryptedMessageAppendix.Type.TO_RECIPIENT;
    }
  ...
  class EncryptToSelfMessage extends AbstractEncryptedMessage {
    ...
    public  EncryptToSelfMessage(ByteBuffer buffer, byte transactionVersion) throws Pc365Exception.ValidationException {
      super(buffer, transactionVersion);
    }
    ...
    public EncryptToSelfMessage(CoreApi.EncryptedMessageAppendix encryptedMessageAppendix, int blockchainHeight) {
      super(encryptedMessageAppendix, blockchainHeight);
      if (encryptedMessageAppendix.getType() != CoreApi.EncryptedMessageAppendix.Type.TO_SELF) throw new IllegalArgumentException();
    }
    ...
    public void validate(Transaction transaction) throws Pc365Exception.ValidationException {
      super.validate(transaction);
      if (transaction.getVersion() == 0) {
        throw new Pc365Exception.NotValidException("Encrypt-to-self message attachments not enabled for version 0 transactions");
      }
    }

    @Override
    protected CoreApi.EncryptedMessageAppendix.Type getType() {
      return CoreApi.EncryptedMessageAppendix.Type.TO_SELF;
    }
  ...
  class PublicKeyAnnouncement extends AbstractAppendix {
    ...
    public PublicKeyAnnouncement(CoreApi.PublicKeyAnnouncementAppendix publicKeyAnnouncementAppendix, int blockchainHeight) {
      super(blockchainHeight);
    ...
    public void validate(Transaction transaction) throws Pc365Exception.ValidationException {
      if (! transaction.getType().hasRecipient()) {
        throw new Pc365Exception.NotValidException("PublicKeyAnnouncement cannot be attached to transactions with no recipient");
      }
      if (publicKey.length != 32) {
        throw new Pc365Exception.NotValidException("Invalid recipient public key length: " + Convert.toHexString(publicKey));
      }
      long recipientId = transaction.getRecipientId();
      if (Account.getId(this.publicKey) != recipientId) {
        throw new Pc365Exception.NotValidException("Announced public key does not match recipient accountId");
      }
      if (transaction.getVersion() == 0) {
        throw new Pc365Exception.NotValidException("Public key announcements not enabled for version 0 transactions");
      }
      ...
      if (recipientAccount != null && recipientAccount.getPublicKey() != null && ! Arrays.equals(publicKey, recipientAccount.getPublicKey())) {
        throw new Pc365Exception.NotCurrentlyValidException("A different public key for this account has already been announced");
      }
    }
    ...
    @Override
    public Any getProtobufMessage() {
      return Any.pack(CoreApi.PublicKeyAnnouncementAppendix.newBuilder()
              .setVersion(super.getVersion())
