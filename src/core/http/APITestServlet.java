...
public class APITestServlet extends HttpServlet {
  ...
  private static final String HEADER_1 =
      ...
      + "            })\n"
      + "            .fail(function() {\n"
      + "                alert('API not available, check if Pc365 Server is running!');\n"
      + "            });\n"
      ...
      + "           <a class=\"navbar-brand\" href=\"/test\">Pc365 http API</a>"
      + "       </div>"
      + "       <div class=\"navbar-collapse collapse\">"
      + "           <ul class=\"nav navbar-nav navbar-right\">"
      + "               <li><input type=\"text\" class=\"form-control\" id=\"search\" "
      + "                    placeholder=\"Search\" style=\"margin-top:8px;\"></li>\n"
      + "               <li><a href=\"https://pc365wiki.org/en/the-pc365-api/\" target=\"_blank\" style=\"margin-left:20px;\">Wiki Docs</a></li>"
  ...
  private String form(String requestType, boolean singleView, String className, List<String> parameters, boolean requirePost) {
    ...
    buf.append("<form action=\"/pc365\" method=\"POST\" onsubmit=\"return submitForm(this);\">");
