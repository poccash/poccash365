...
import core.http.APIServlet.HttpRequestHandler;
...
public class GenerateDeeplinkQRCode extends HttpRequestHandler {
  ...
  public void processRequest(HttpServletRequest req, HttpServletResponse resp) {
    try {
      ...
      final BufferedImage qrImage = deeplinkQRCodeGenerator.generateRequestPc365DeepLinkQRCode(receiverId, amountNQT, feeSuggestionType, feeNQT, message, immutable);
