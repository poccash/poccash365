...
abstract class CreateTransaction extends APIServlet.JsonRequestHandler {
  ...
  final JsonElement createTransaction(HttpServletRequest req, Account senderAccount, Long recipientId, long amountNQT, Attachment attachment) throws Pc365Exception {
  ...
  private long minimumFeeNQT() {
    return Pc365.getFluxCapacitor().getValue(FluxValues.PRE_DYMAXION) ? FEE_QUANT : ONE_PC365;
  }
