...
public class Block extends TableImpl<BlockRecord> {
    ...
    public core.schema.tables.Block constraint_3c() {
        return new core.schema.tables.Block(this, Keys.CONSTRAINT_3C);
    }

    public core.schema.tables.Block constraint_3c5() {
        return new core.schema.tables.Block(this, Keys.CONSTRAINT_3C5);
    }
