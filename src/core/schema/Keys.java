...
import core.schema.tables.records.*;
...
public class Keys {
    ...
    private static class ForeignKeys0 {
        public static final ForeignKey<BlockRecord, BlockRecord> CONSTRAINT_3C = Internal.createForeignKey(core.schema.Keys.KEY_BLOCK_BLOCK_ID_IDX, Block.BLOCK, "constraint_3c", Block.BLOCK.PREVIOUS_BLOCK_ID);
        public static final ForeignKey<BlockRecord, BlockRecord> CONSTRAINT_3C5 = Internal.createForeignKey(core.schema.Keys.KEY_BLOCK_BLOCK_ID_IDX, Block.BLOCK, "constraint_3c5", Block.BLOCK.NEXT_BLOCK_ID);
        public static final ForeignKey<TransactionRecord, BlockRecord> CONSTRAINT_FF = Internal.createForeignKey(core.schema.Keys.KEY_BLOCK_BLOCK_ID_IDX, Transaction.TRANSACTION, "constraint_ff", Transaction.TRANSACTION.BLOCK_ID);
    }
}
